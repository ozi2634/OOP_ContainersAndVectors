...
import container.DummyContainer;
...
public class ContainerTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * TODO: Uncomment to test equals and toString in AbstractContainer List l1 =
		 * new List(); List l2 = new List(); l1.add("Test1"); l2.add("Test2");
		 * l1.add("Test2"); l2.add("Test2"); testContainerEqualsToString(l1, l2);
		 */
	}
}